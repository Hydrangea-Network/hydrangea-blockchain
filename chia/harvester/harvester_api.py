...
from hydrangea.plotting.util import PlotInfo, parse_plot_info
from hydrangea.protocols import harvester_protocol
from hydrangea.protocols.farmer_protocol import FarmingInfo
from hydrangea.protocols.harvester_protocol import Plot, PlotSyncResponse
from hydrangea.protocols.protocol_message_types import ProtocolMessageTypes
from hydrangea.server.outbound_message import make_msg
...
from hydrangea.wallet.derive_chives_keys import chives_master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSHydrangeaConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSHydrangeaConnection
    ):
        """
