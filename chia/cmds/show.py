...
from hydrangea.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'hydrangea show -c' has been renamed to 'hydrangea peer -c' ")
    if add_connection != "":
        print("'hydrangea show -a' has been renamed to 'hydrangea peer -a' ")
    if remove_connection != "":
        print("'hydrangea show -r' has been renamed to 'hydrangea peer -r' ")
    if wallet_rpc_port is not None:
        print("'hydrangea show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
