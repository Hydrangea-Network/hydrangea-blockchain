...
from chia.wallet.derive_chives_keys import master_sk_to_chives_farmer_sk, master_sk_to_chives_pool_sk
...
def _search_derived(
    ...
    for index in range(limit):
        ...
        if search_address:
            ...
            address = encode_puzzle_hash(create_puzzlehash_for_pk(child_pk), "xhg")
