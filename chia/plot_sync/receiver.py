...
from hydrangea.plot_sync.exceptions import (
...
from hydrangea.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    _connection: WSHydrangeaConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSHydrangeaConnection:
