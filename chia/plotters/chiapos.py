"""
NOTE: This contains duplicate code from `hydrangea.cmds.plots`.
After `hydrangea plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Hydrangea Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_hydrangea(args, root_path):
    try:
