...
class ConsensusConstants:
    ...
    # Forks of hydrangea should change this value to provide replay attack protection
    ...
    GENESIS_PRE_FARM_STAKING_PUZZLE_HASH: bytes32  # The block at height must pay out to this staking puzzle hash
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M hydrangea.
    MAX_COIN_AMOUNT: int
