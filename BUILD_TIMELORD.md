...
required to run a [Timelord](https://github.com/Hydrangea-Network/hydrangea-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Hydrangea-Network/hydrangea-blockchain/blob/main/install-timelord.sh)
