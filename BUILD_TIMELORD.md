...
required to run a [Timelord](https://github.com/Chia-Network/hydrangea-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/hydrangea-blockchain/blob/main/install-timelord.sh)
