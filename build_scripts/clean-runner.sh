...
rm -rf ../venv || true
rm -rf venv || true
rm -rf hydrangea_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf hydrangea-blockchain-gui/build || true
rm -rf hydrangea-blockchain-gui/daemon || true
rm -rf hydrangea-blockchain-gui/node_modules || true
rm hydrangea-blockchain-gui/temp.json || true
( cd "$PWD/hydrangea-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
