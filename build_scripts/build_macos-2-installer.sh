...
LAST_EXIT_CODE=$?
ls -l dist/mac*/hydrangea.app/Contents/Resources/app.asar
...
DMG_NAME="hydrangea-${HYDRANGEA_INSTALLER_VERSION}.dmg"
if [ "$(arch)" = "arm64" ]; then
  mv dist/${DMG_NAME} dist/hydrangea-${HYDRANGEA_INSTALLER_VERSION}-arm64.dmg
