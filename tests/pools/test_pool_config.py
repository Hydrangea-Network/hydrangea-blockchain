...
from hydrangea.pools.pool_config import PoolWalletConfig
from hydrangea.util.config import create_default_hydrangea_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_hydrangea_config(test_root, ["config.yaml"])
