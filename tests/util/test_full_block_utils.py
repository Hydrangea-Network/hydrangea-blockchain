...
from hydrangea.util.full_block_utils import block_info_from_block, generator_from_block, header_block_from_block
...
def get_foliage_block_data() -> Generator[FoliageBlockData, None, None]:
    for pool_signature in [g2(), None]:
        ...
        yield FoliageBlockData(
            ...
            hsh(),  # staking_reward_puzzle_hash
            hsh(),  # community_reward_puzzle_hash
            hsh(),  # timelord_reward_puzzle_hash
            hsh(),  # extension_data
        )
