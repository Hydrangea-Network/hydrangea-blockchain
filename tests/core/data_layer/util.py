...
from hydrangea.data_layer.data_layer_util import NodeType, Side, Status
...
class HydrangeaRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["HYDRANGEA_ROOT"] = os.fspath(self.path)
        kwargs["env"]["HYDRANGEA_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("hydrangea"),
            "--root-path",
            self.path,
            *args,
        ]
