...
from hydrangea.protocols.protocol_state_machine import message_response_ok
from hydrangea.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from hydrangea.protocols.shared_protocol import Capability, Handshake
from hydrangea.server.outbound_message import Message, NodeType, make_msg
from hydrangea.server.rate_limits import RateLimiter
from hydrangea.types.peer_info import PeerInfo
from hydrangea.util.errors import Err, ProtocolError
from hydrangea.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from hydrangea.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSHydrangeaConnection:
    """
