...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Hydrangea keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (xhg for mainnet, txhg for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
