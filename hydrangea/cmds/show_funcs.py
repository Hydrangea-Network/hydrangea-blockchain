...
async def print_blockchain_state(node_client: FullNodeRpcClient, config: Dict[str, Any]) -> bool:
    ...
    if synced:
        ...
        print("You may be able to expedite with 'hydrangea show -a host:port' using a known node.\n")
...
async def print_block_from_hash(
    ...
    if block is not None:
        ...
        staking_address = encode_puzzle_hash(block.staking_puzzle_hash, address_prefix)
        ...
        print(
            ...
            f"Staking Address        {staking_address}\n"
