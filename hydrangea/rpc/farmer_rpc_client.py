...
from hydrangea.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from hydrangea.rpc.rpc_client import RpcClient
from hydrangea.types.blockchain_format.sized_bytes import bytes32
from hydrangea.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Hydrangea RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
