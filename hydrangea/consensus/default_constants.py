...
default_kwargs = {
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("68796472616e67656120666f72207468652077696efd36501dd6988bdbb72022"),
    # Forks of hydrangea should change this value to provide replay attack protection. This is set to mainnet genesis chall
