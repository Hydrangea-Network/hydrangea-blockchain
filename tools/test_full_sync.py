...
from hydrangea.cmds.init_funcs import hydrangea_init
...
from hydrangea.simulator.block_tools import make_unfinished_block
...
class FakeServer:
    ...
    def get_full_node_outgoing_connections(self) -> List[ws.WSHydrangeaConnection]:
        return []
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        hydrangea_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSHydrangeaConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    hydrangea_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
