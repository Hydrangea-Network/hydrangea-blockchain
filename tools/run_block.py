...
"""
run_block: Convert an encoded FullBlock from the Hydrangea blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../hydrangea/types/full_block.py) in json format
...
$hash is the header_hash of the [BlockRecord](../hydrangea/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../hydrangea/types/condition_opcodes.py)
...
from hydrangea.wallet.cat_wallet.cat_utils import match_cat_puzzle
